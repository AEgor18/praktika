...
def get_url(page):
    url = f'https://hh.ru/search/vacancy?text={text}&salary=&ored_clusters=true&items_on_page={items}&hhtmFrom=vacancy_search_list&hhtmFromLabel=vacancy_search_line&page={page}'
